...
export default class TypeBuilder {
    ...
    Sheet: ClassViewer<'Sheet', "title" | "total_cols" | "total_rows" | "content_type" | "tables">;
    
    Spreadsheet: ClassViewer<'Spreadsheet', "sheets" | "brief_summary">;
    
    Table: ClassViewer<'Table', "headers" | "data_rows" | "description">;
    ...
    constructor() {
        ...
        this.Sheet = this.tb.classViewer("Sheet", [
          "title","total_cols","total_rows","content_type","tables",
        ]);
        
        this.Spreadsheet = this.tb.classViewer("Spreadsheet", [
          "sheets","brief_summary",
        ]);
        
        this.Table = this.tb.classViewer("Table", [
          "headers","data_rows","description",
        ]);
