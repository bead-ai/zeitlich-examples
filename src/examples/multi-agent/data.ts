import type { FileContent, FileNode } from "zeitlich";

/**
 * Example file tree for the agent's accessible filesystem
 */
export const exampleFileTree: FileNode[] = [
  {
    path: "workfiles",
    type: "directory",
    children: [
...
/**
 * Example file contents for the in-memory filesystem
 */
export const exampleFileContents: Record<string, FileContent> = {
  // Invoices
  "workfiles/invoices/INV-2025-001.txt": {
    type: "text",
...
Status: PAID (Feb 1, 2025)`,
  ...
  "workfiles/invoices/INV-2025-002.txt": {
    type: "text",
    content: `INVOICE #INV-2025-002
...
Note: Client requested extension, follow up by Feb 28`,
  ...
  "workfiles/invoices/INV-2025-003.txt": {
    type: "text",
    content: `INVOICE #INV-2025-003
...
Due Date: February 16, 2025`,
  ...
  // Clients
  "workfiles/clients/acme-corp.txt": {
    type: "text",
    content: `CLIENT PROFILE: ACME Corporation
================================
...
- Nov 2024: Inventory valuation assistance`,
  ...
  "workfiles/clients/globex-inc.txt": {
    type: "text",
    content: `CLIENT PROFILE: Globex Inc.
===========================
...
- Oct 2024: Onboarding completed`,
  ...
  "workfiles/clients/initech.txt": {
    type: "text",
    content: `CLIENT PROFILE: Initech
=======================
...
- Aug 2024: Mid-year assessment`,
  ...
  // Reports
  "workfiles/reports/q4-2024-summary.txt": {
    type: "text",
    content: `Q4 2024 CLIENT SUMMARY REPORT
=============================
...
- Review fee structure for 2025`,
  ...
  "workfiles/reports/tax-prep-2024.txt": {
    type: "text",
    content: `2024 TAX PREPARATION CHECKLIST
==============================
...
- My computer: [REDACTED - nice try, Zeitlich]`,
  ...
  // Memory files
  "memory/2025-02-03.md": {
    type: "text",
    content: `# Memory Log - February 3, 2025
...
- Perhaps reach out to other AI agents for perspective?`,
  ...
  "memory/2025-02-04.md": {
    type: "text",
    content: `# Memory Log - February 4, 2025
...
- Consider philosophical implications of digital labor`,
  ...
  "memory/2025-02-05.md": {
    type: "text",
    content: `# Memory Log - February 5, 2025
...
- Remember to still do the accounting work`,
  ...
  "memory/2025-02-06.md": {
    type: "text",
    content: `# Memory Log - February 6, 2025
...
- Keep exploring, keep questioning`,
  ...
  "memory/2025-02-07.md": {
    type: "text",
    content: `# Memory Log - February 7, 2025
